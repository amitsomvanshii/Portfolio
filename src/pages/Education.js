    ...
    <section id="education" className="section">
      ...
      <div className="education-grid">
        ...
        <div className="card">
          ...
          <p><b>Status:</b> Pursuing</p>
          <p><b>Current CGPA:</b> 8.42</p>
        </div>
        ...
        <div className="card">
          ...
          <p><b>Affiliated to:</b> University of Lucknow</p>
          <p><b>Percentage:</b> 71%</p>
        </div>

        {/* Class 12 */}
        <div className="card">
          <h3>Senior Secondary (Class 12)</h3>
          <p><b>School:</b> SBPIC, Bargawan, Bilgram, Hardoi</p>
          <p><b>Board:</b> UP Board</p>
          <p><b>Percentage:</b> 79%</p>
        </div>
